...
import at.refugeescode.psetstest.pset1.model.Actor;
import at.refugeescode.psetstest.pset1.model.Gender;
import at.refugeescode.psetstest.pset1.model.Movie;
import at.refugeescode.psetstest.pset1.model.Summary;
import at.refugeescode.psetstest.pset1.parser.ActorParser;
import at.refugeescode.psetstest.pset1.parser.MovieParser;
...
public class MovieDatabaseSummarizer {
    ...
    public Summary summarize() {
        ...
        List<Movie> movies = movieParser.asList("src/main/java/at/refugeescode/psetstest/pset1/data/movies.csv");
        List<Actor> actors = actorParser.asList("src/main/java/at/refugeescode/psetstest/pset1/data/actors.csv");
